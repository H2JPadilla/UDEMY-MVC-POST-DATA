  ...
  public class FavController : Controller
  {
    ...
    public ActionResult UpdateFav(FavDTO model)
    {
      ...
      else
      {
        ...
        if (model.LogoImage != null)
        {
          if (System.IO.File.Exists(Server.MapPath("~/Areas/Admin/Content/LogoImages/" + returndto.Logo)))
          {
            System.IO.File.Delete(Server.MapPath("~/Areas/Admin/Content/LogoImages/" + returndto.Logo));
          }
        }
